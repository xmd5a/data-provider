...
const projectDetails_2: GetProjectDetailsResponse = {
  ...
  title: 'title 2',
  description: {
    text: '<b>Less Deforestation of the Rainforest due to Efficient Cook Stoves in Kenya</b> <p></p>Locally produced efficient Upesi stoves reduce wood consumption in Kenya and help to preserve the unique vegetation and biodiversity of Kakamega rainforest.</p>',
    text_ext:
